...
try {
    ...
    $mail->Username   = 'karthiksandiri23@gmail.com';                     //SMTP username
    $mail->Password   = 'Your Gmail ID APP password';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    $mail->setFrom('karthiksandiri23@gmail.com ', 'Email Enquiry');
    $mail->addAddress('$to', 'KARTHIK SANDIRI');     //Add a recipient
